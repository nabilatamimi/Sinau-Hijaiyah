...
public class kuis1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton ca12 = (ImageButton) findViewById(R.id.kuis3);
        preview = (ImageView) findViewById(R.id.hasil);
        ca12.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        final MediaPlayer ca4 = MediaPlayer.create(this, R.raw.salah);
        ...
        final MediaPlayer ca19 = MediaPlayer.create(this, R.raw.salah);
        ...
        final MediaPlayer play = MediaPlayer.create(this, R.raw.ca12);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intentpindah = new Intent(kuis1.this, kuis2.class);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentpindah = new Intent(kuis1.this, kuis.class);
                startActivity(intentpindah);
            }
        });
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentpindah = new Intent(kuis1.this, Activity.class);
                startActivity(intentpindah);
            }
        });
    }
